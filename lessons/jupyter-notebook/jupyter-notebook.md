...
![Notebook UI](assets/jupyter_notebook_home.png)
...
![Notebook UI](assets/jupyter_notebook_new.png)
...
![první příkaz](assets/first_command.png)
...
![ukázka výstupů](assets/outputs.png)
...
![špatné pořadí spuštění buňek](assets/wrong_order.png)
...
![příklady v Pythonu](assets/python_example.png)
...
hranatou závorkou vykřičník: `![logo pythonu](assets/python_logo.png)`

Tímto způsobem jednoduše formátovaný text by mohl vypadat následovně:

![markdown source](assets/markdown_source.png)
...
![latex examples](assets/latex_examples.png)
...
[GIT repozitáři](https://github.com/PyDataCZ/pyladies-kurz/tree/main/lessons/jupyter-notebook).
